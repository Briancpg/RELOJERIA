...
class Repair(Base, TimestampMixin, SoftDeleteMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint("internal_cost >= 0", name="internal_cost_non_negative"),
    ...
    exit_date: Mapped[date | None] = mapped_column(Date, index=True, nullable=True)
    ...
    internal_cost: Mapped[Decimal] = mapped_column(Numeric(12, 2), default=Decimal("0"), nullable=False)
